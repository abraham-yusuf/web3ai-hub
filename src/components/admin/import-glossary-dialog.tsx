...
export function ImportGlossaryDialog() {
  ...
  async function handleImport(e: React.FormEvent) {
    ...
    try {
      ...
      setResult(`${data.saved} istilah berhasil disimpan ke glossary.`)
      setTopic("")
      setSector("")
      setCount(15)
    } catch (err) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="w-full max-w-md rounded-xl border bg-background p-6 shadow-lg">
            <div className="mb-4 flex items-center justify-between">
              <h2 className="text-lg font-semibold">📥 Import dari AI</h2>
              <button
                type="button"
                onClick={closeDialog}
            ...
            {result ? (
              ...
              <form onSubmit={handleImport} className="space-y-4">
                ...
                <div>
                  <label className="mb-1 block text-xs font-medium">Jumlah Istilah</label>
