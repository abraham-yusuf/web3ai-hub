  ...
  return (
    <div className="flex flex-col gap-16 py-8 md:py-12">
      <section className="flex flex-col items-center gap-6 text-center">
        ...
        <p className="text-body-lg max-w-[800px] text-muted-foreground">
      ...
      <section className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        <Card className="group relative overflow-hidden">
          <CardHeader>
            <BlogIcon className="mb-2 h-10 w-10 text-primary" />
        ...
        <Card className="group relative overflow-hidden">
          <CardHeader>
            <LearnIcon className="mb-2 h-10 w-10 text-secondary" />
        ...
        <Card className="group relative overflow-hidden">
          <CardHeader>
            <AirdropIcon className="mb-2 h-10 w-10 text-accent" />
        ...
        <Card className="group relative overflow-hidden">
          <CardHeader>
            <ToolsIcon className="mb-2 h-10 w-10 text-success" />
